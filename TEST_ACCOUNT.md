...
Просто откройте в браузере или выполните:

```bash
curl -X POST https://alchin-crm.vercel.app/api/crm/setup/create-test-admin
```

Или откройте в браузере:
**https://alchin-crm.vercel.app/api/crm/setup/create-test-admin**

Это автоматически создаст тестового администратора!

### Способ 2: Через API регистрации
...
### Способ 4: Через Node.js скрипт (локально)
